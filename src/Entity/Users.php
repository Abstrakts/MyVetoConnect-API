...
class Users implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Animales", mappedBy="user")
     */
    private $animales;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Veterinaries", inversedBy="users")
     */
    private $veterinary;
    ...
    public function removeAnimale(Animales $animale): self
    {
        if ($this->animales->contains($animale)) {
            ...
            if ($animale->getUser() === $this) {
                $animale->setUser(null);
            }
        }
